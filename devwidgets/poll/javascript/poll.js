...
require(["jquery", "sakai/sakai.api.core"], function($, sakai) {
     ...
     */
    sakai_global.poll = function(tuid, showSettings){
        ...
        var renderShowQuestion = function(){
            $(pollShowQuestion, rootel).html(sakai.api.Util.TemplateRenderer(pollShowQuestionTemplate,json));
        };
        ...
        var renderShowChart = function(){
            $(pollShowChart, rootel).html(sakai.api.Util.TemplateRenderer(pollShowChartTemplate,json));
        };
        ...
        var renderPreview = function(){
            $(pollPreviewQuestion, rootel).html(sakai.api.Util.TemplateRenderer(pollPreviewQuestionTemplate,json));
            $(pollPreviewChart, rootel).html(sakai.api.Util.TemplateRenderer(pollPreviewChartTemplate,json));
        };
        ...
        var renderOptions = function(){
            $(pollOptions, rootel).html(sakai.api.Util.TemplateRenderer(pollOptionsTemplate,json));
        };
        ...
        var renderSettings = function(){
            $(pollSettings, rootel).html(sakai.api.Util.TemplateRenderer(pollSettingsTemplate,json));
            renderOptions();
        };
